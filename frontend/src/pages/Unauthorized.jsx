    ...
    <main style={{ minHeight: "80vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem", background: "linear-gradient(135deg, #f1f4fb 0%, #fff 100%)" }}>
      <div style={{ maxWidth: "480px", width: "100%", textAlign: "center", padding: "3rem 2rem", background: "#fff", borderRadius: "1.5rem", border: "1px solid #e8edf5", boxShadow: "0 8px 32px rgba(53,64,143,0.08)" }}>
        ...
        <p style={{ fontSize: "0.85rem", color: "#64748b", lineHeight: 1.7, margin: "0 0 2rem" }}>
          ...
          {isLoggedIn && " If you believe this is a mistake, please contact the IT Admin."}
        </p>
        <div style={{ display: "flex", gap: "0.75rem", justifyContent: "center", flexWrap: "wrap" }}>
          <button
            onClick={() => navigate(-1)}
            style={{ padding: "0.65rem 1.25rem", borderRadius: "0.7rem", fontSize: "0.82rem", fontWeight: 700, background: "#f1f5f9", color: "#64748b", border: "none", cursor: "pointer" }}
          >
            ← Go Back
          </button>
          ...
          {isLoggedIn ? (
            <button
              ...
              style={{ padding: "0.65rem 1.25rem", borderRadius: "0.7rem", fontSize: "0.82rem", fontWeight: 700, background: "#35408f", color: "#ffd700", border: "none", cursor: "pointer" }}
            >
              My Dashboard
            </button>
          ) : (
          ...
          <button
            onClick={() => navigate("/")}
            style={{ padding: "0.65rem 1.25rem", borderRadius: "0.7rem", fontSize: "0.82rem", fontWeight: 700, background: "#f8faff", color: "#35408f", border: "1.5px solid #35408f30", cursor: "pointer" }}
          >
            Home
          </button>
        </div>
